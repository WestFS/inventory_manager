...
def main_screen():
    ...
    main_window.geometry("720x450")
    main_window.resizable(False, False)

    ctk.CTkLabel(main_window, text="Bem-vindo!").pack(pady=20)
